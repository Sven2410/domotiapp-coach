...
vast_krap = vast_zonnig.kopie(
    naam="vast-krappe-klaar-tijd", uitleg="vast contract, bus op 40% om 13:00 erin, klaar om 17:00: het past net",
    begin="2026-09-07 12:55", kabel_erin="13:00", klaar_om="17:00", duur_uren=6,
    auto=replace(BUS, soc=40.0),
)
...
een_fase_krap = vast_zonnig.kopie(
    ...
    begin="2026-09-07 16:55", kabel_erin="17:00", klaar_om="23:00", duur_uren=7,
    auto=replace(BUS, soc=20.0), stap_seconden=10,
)
...
niet_voor = vast_zonnig.kopie(
    naam="niet-voor-23", uitleg="vast, laden mag pas vanaf 23:00",
    niet_voor="23:00",
)
uiterlijk_starten = vast_zonnig.kopie(
    naam="uiterlijk-starten-22", uitleg="dynamisch, geen zon, uiterlijk om 22:00 beginnen wat het ook kost",
    contract="dynamisch", uiterlijk_starten="22:00", zon=Zon(wolken="geen"), voorspeller="geen",
    begin="2026-09-07 18:25", kabel_erin="18:30", duur_uren=13,
)
...
ALLE = [
    ...
    pauze, pauze_vergeten, snelladen, kabel_eruit, niet_voor, uiterlijk_starten,
